...
The goal of pangoling is to use transformer models to get log-probabilities of words. It's a wrapper of the python package [`transformer`](https://pypi.org/project/transformers/).

## Installation

There is still no released version of `pangoling`. The package is in the early stages of development, and it will be subject to a lot of changes. To install the latest version from github use:
