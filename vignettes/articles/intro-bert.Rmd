...
Whereas [the vignette about GPT-2](intro-gpt2.html) presents a very popular way to calculate word probabilities using GPT-like models, masked models present an alternative, especially, when we just care about the final word following a certain context.
