...
```{r}
(df_masks <- get_masked_tokens_tbl("The apple doesn't fall far from the [MASK][MASK]"))
```

```{r}
get_masked_tokens_tbl("[CLS] The apple doesn't fall far from the [MASK]",add_special_tokens = FALSE)
```
