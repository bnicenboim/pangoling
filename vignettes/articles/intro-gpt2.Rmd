...
Going back to the initial example, because `causal_next_tokens_tbl` returns log (natural) probabilities, if we exponentiate them and we sum them, we should get 1:
